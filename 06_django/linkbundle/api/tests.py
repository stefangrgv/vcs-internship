...
def test_get_others_private_list(signed_in_user, private_list):
    resp = signed_in_user.get(reverse('list-view-detail', kwargs={'pk': private_list.id}))
...
def test_get_my_private_list(signed_in_private_user, private_list):
    resp = signed_in_private_user.get(reverse('list-view-detail', kwargs={'pk': private_list.id}))
    assert resp.status_code == 200
